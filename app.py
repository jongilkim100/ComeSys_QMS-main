...
고객사라인부적합현황 = 고객사라인부적합현황[고객사라인부적합현황['year'] == '2024'].copy()

고객사라인부적합현황합계_2024 = int(고객사라인부적합현황['수량'].sum())
...
필드클레임현황 = 필드클레임현황[필드클레임현황['year'] == '2024'].copy()

필드클레임현황합계_2024 = int(필드클레임현황['청구금액'].sum())
...
QCOST현황 = QCOST현황[QCOST현황['year'] == '2024'].copy()

QCOST현황합계_2024 = int(QCOST현황['QCOST'].sum())
